...
<head>
    ...
    <title>{{ Auth::user()->level }} - {{ config('app.name', 'Laravel') }}</title>
...
<body>
            ...
            <div class="brand-logo">
                <a href="{{ url('/home') }}">
                    ...
                    <span class="brand-title">
                        ...
                        <span class="text-white ml-2">SIM<b>RA</b></span>
                    </span>
                </a>
            </div>
        </div>
                ...
                @if(Auth::user()->level == "admin")
                    <li>
                        <a href="{{ route('kategori') }}" aria-expanded="false">
                            <i class="icon-grid menu-icon mr-3"></i><span class="nav-text">Jenis Anggaran</span>
                        </a>
                    </li>
                @endif
                <li>
    ...
    <div class="footer">
        <div class="copyright">
            <p>Copyright &copy; Sistem Informasi Monitoring & Realisasi Anggaran {{ date('Y') }}</p>
        </div>
    </div>
</div>
