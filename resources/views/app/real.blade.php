              ...
              <div class="card-body">
                ...
                <div class="default-tab">
                  <ul class="nav nav-tabs mb-4" role="tablist">
                      <li class="nav-item"><a class="nav-link "  href="{{ route('test') }}">PAGU</a>
                      </li>
                      <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#realisasi">Progress Realisasi</a>
                      </li>
                  </ul>
                  <div class="tab-content">
                      <div class="tab-pane fade " id="pagu" role="tabpanel">
                          <div class="p-t-15">
                            <div class="custom-media-object-1">
                                   
                          </div>
                      </div>
                      <div class="tab-pane fade active show" id="realisasi" role="tabpanel">
                          <div class="p-t-15">
                            <div class="custom-media-object-1">
                  ...
                  @foreach($pengeluaran as $p )
                    <div class="row">
                        <div class="col-lg-6">
                            <h5>{{ $no++ }}. {{ $p->kategori }}</h5>
                            <p class="badge badge-primary">Realisasi Anggaran</p>
                        </div>
                        <div class="col-lg-6 text-right">
                          @foreach ($p->transaksiCount2 as $t)
